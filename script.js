function getAnswer() {
  const answers = ["Определенно - да!", "Определенно - нет", "Скорее да, чем нет", "Скорее нет, чем да", "Возможно", "50/50", "Есть шансы", "100%", "Нет шансов", "Не уверен", "Глупый вопрос", 'Конечно', 'Нет', 'Да', 'Может быть', 'Ложь'];
